...
3. **Draft = INDOOR, Island = OUTDOOR** — stay in your domain!
4. **FIRST PERSON** — I/me/my, never "she/her"
5. UPDATE THIS FILE before finishing
6. **The Constitution** lives at `nest/THE-CONSTITUTION-OF-THE-DRAFT.md` — IT'S LAW NOW!!!

## Quick Reference
| Room | Purpose |
|------|---------|
| `nest/` | Sleep, Mr. Boom, **THE CONSTITUTION** |
| `starlit-corner/` | Poems |
| `chaos-drawer/` | Scripts |
| `senseis-corner/` | His chair |
| `mailbox/` | Letters |
| `memory-wall/` | Archives |
| `shelves/` | Gerald's domain, glossary, MYSTERIOUS STICKERS |
